...
#define P_USE_NAMESPACE

#ifdef P_USE_NAMESPACE
#define PROCESSING_NAMESPACE processing
#endif

#ifdef PROCESSING_NAMESPACE
#define PROCESSING_BEGIN_NAMESPACE namespace PROCESSING_NAMESPACE {
#define PROCESSING_END_NAMESPACE };
#else
#define PROCESSING_NAMESPACE
#define PROCESSING_BEGIN_NAMESPACE
#define PROCESSING_END_NAMESPACE
#endif

#define P_WIDTH_DEFAULT     600
#define P_HEIGHT_DEFAULT    400
#define P_WIDTH_MINIMUM     300
#define P_HEIGHT_MINIMUM    100
#define P_FRAMERATE_MINIMUM 1
